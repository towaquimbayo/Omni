      ...
      >
        ...
        <div className="w-1/2 relative flex flex-col">
          ...
          <div className="absolute top-8 left-8">
            <h1 className="text-3xl font-bold text-white">omni</h1>
          </div>
          ...
          <div className="px-8 pb-8">
            <div className="flex flex-col p-4 bg-white/10 rounded-3xl">
              <p className="text-white/90 text-md italic mb-2">
